...
namespace LivingParisApp.Tests {
    public class ShortestPathTests {
        ...
        public void Dijkstra_EmptyPath_WhenNoPathExists() {
            ...
            map.AddBidirectionalEdge(stationA.Object, stationB.Object, 10.0);
            map.AddBidirectionalEdge(stationA.Object, stationC.Object, double.PositiveInfinity);
        ...
        public void Dijkstra_SingleVertexPath_ReturnsZeroLengthPath() {
            ...
            map.AddBidirectionalEdge(stationA.Object, stationB.Object, 5.0);
        ...
        public void BellmanFord_NegativeWeightEdges_ReturnsShortestPath() {
            ...
            map.AddBidirectionalEdge(stationA.Object, stationB.Object, 2.0);
            map.AddBidirectionalEdge(stationB.Object, stationC.Object, -1.0);
            map.AddBidirectionalEdge(stationA.Object, stationC.Object, 3.0);

            var bellmanFord = new BellmanFord<MetroStation>();
            var test = bellmanFord.Init(map, stationA);
            Assert.Equal(1, test);
        }
        ...
        public void FloydWarshall_ComplexGraph_FindsCorrectPaths() {
            ...
            map.AddBidirectionalEdge(stationA.Object, stationB.Object, 2.0);
            map.AddBidirectionalEdge(stationB.Object, stationC.Object, 3.0);
            map.AddBidirectionalEdge(stationC.Object, stationD.Object, 1.0);
            map.AddBidirectionalEdge(stationD.Object, stationE.Object, 2.0);
            map.AddBidirectionalEdge(stationA.Object, stationE.Object, 10.0);
        ...
        public void Astar_MultiplePossiblePaths_FindsOptimalPath() {
            ...
            map.AddBidirectionalEdge(stationA.Object, stationB.Object, 1.0);
            map.AddBidirectionalEdge(stationB.Object, stationC.Object, 2.0);
            map.AddBidirectionalEdge(stationC.Object, stationE.Object, 3.0);
            map.AddBidirectionalEdge(stationA.Object, stationD.Object, 4.0);
            map.AddBidirectionalEdge(stationD.Object, stationE.Object, 2.0);
        ...
        public void Astar_PerformanceComparedToDijkstra() {
            ...
            map.AddBidirectionalEdge(stationA.Object, stationB.Object, abDistance);
            map.AddBidirectionalEdge(stationB.Object, stationC.Object, bcDistance);
            map.AddBidirectionalEdge(stationC.Object, stationD.Object, cdDistance);
        ...
        public void BellmanFord_GetPath_ReturnsShortestPath() {
            ...
            // Set up the graph exactly as in Dijkstra test
            map.AddBidirectionalEdge(stationA.Object, stationB.Object, 10.0);
            map.AddBidirectionalEdge(stationA.Object, stationC.Object, 2.0);
            map.AddBidirectionalEdge(stationB.Object, stationD.Object, 3.0);
            map.AddBidirectionalEdge(stationC.Object, stationD.Object, 5.0);
        ...
        public void FloydWarshall_GetPath_ReturnsShortestPath() {
            ...
            // Set up the graph exactly as in Dijkstra test
            map.AddBidirectionalEdge(stationA.Object, stationB.Object, 4.0);
            map.AddBidirectionalEdge(stationA.Object, stationC.Object, 2.0);
            map.AddBidirectionalEdge(stationB.Object, stationD.Object, 3.0);
            map.AddBidirectionalEdge(stationC.Object, stationD.Object, 10.0);
        ...
        public void Astar_GetPath_ReturnsShortestPath() {
            ...
            map.AddBidirectionalEdge(stationA.Object, stationB.Object, abDistance);
            map.AddBidirectionalEdge(stationA.Object, stationC.Object, acDistance);
            map.AddBidirectionalEdge(stationB.Object, stationD.Object, bdDistance);
            map.AddBidirectionalEdge(stationC.Object, stationD.Object, cdDistance);
